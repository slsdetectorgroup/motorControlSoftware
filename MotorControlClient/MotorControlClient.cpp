...
int MotorControlClient::Connect(char* host_ip_or_name)
{
#ifdef VERY_VERBOSE
...
char* MotorControlClient::SendCommand(int argc, char arg[])
{
  char args[255];
  strcpy(args,arg);
...
void MotorControlClient::Disconnect()
{
  // disconnects socket
  sock->Disconnect();
