...
This class provides a simple interface for creating and sending/receiving data over a TCP socket.  
...
The \doxyref{My\-Socket\-TCP}{p.}{classMySocketTCP} class provides a simple interface for creating and sending/receiving data over a TCP socket.

\begin{Desc}
\item[Author:]Ian Johnson \end{Desc}
\begin{Desc}
...
\index{MySocketTCP@{My\-Socket\-TCP}!SetTimeOut@{SetTimeOut}}
\index{SetTimeOut@{SetTimeOut}!MySocketTCP@{My\-Socket\-TCP}}
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}int My\-Socket\-TCP::Set\-Time\-Out (int {\em ts})}\label{classMySocketTCP_55ecc3df1997e72d81104176a712e783}
...
My\-Socket\-TCP/\bf{My\-Socket\-TCP.cpp}\end{CompactItemize}
