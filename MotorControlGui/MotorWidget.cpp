...
MotorControlClient * MotorWidget::client= new MotorControlClient();
  ...
  if(strcmp(Name,"static"))
    {
      ...
      //iPlus = new QIcon( "images/plusImage.png" );
      //iMinus = new QIcon( "images/minusImage.png" );      
      iPlus = new QIcon( ":/icons/images/plusImage.png" );
      iMinus = new QIcon( ":/icons/images/minusImage.png" );  
      plus->setIcon(*iPlus);
      plus->setIconSize(QSize(49,15));
      minus->setIcon(*iMinus);
      minus->setIconSize(QSize(49,15));
...
void MotorWidget::Initialization()
{
  ...
  //connections
  connect(minus,SIGNAL(clicked()),this,SLOT(MoveRelative()));
  connect(plus,SIGNAL(clicked()),this,SLOT(MoveRelative()));   
}
...
void MotorWidget::MoveRelative()
{
  ...
  if(!QString::compare(text, ""))
  ...
  else
    {
      ...
      if(clickedButton->icon().pixmap(QSize(49,15)).toImage()==iMinus->pixmap(QSize(49,15)).toImage())
	pos=0-pos;
