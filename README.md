...
###### Motor
    ...
    rangemeasure [motor] - moves motor to end hard switch to measure complete range of motor, returns 
        final position
...
###### Controller
    ...
    readcontroller [controller] [Commands..] - send controller commands and read back result 
        (beware it should have result)
...
###### Advanced/ Debugging
    ...
    addholder [fluorscence motor] [Target1] [Energy 1] ..[Target8] [Energy 8] - add new holder with 8 target 
        names and corresponding energies 
